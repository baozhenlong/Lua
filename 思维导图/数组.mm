...
<node TEXT="数组" FOLDED="false" ID="ID_100776476" CREATED="1601720331676" MODIFIED="1769251864548" LINK="Lua.mm#ID_33400172" NodeVisibilityConfiguration="SHOW_HIDDEN_NODES" CHILD_NODES_LAYOUT="TOPTOBOTTOM_RIGHT_AUTO"><hook NAME="MapStyle" background="#ecf4f9ff" zoom="1.5">
...
<node POSITION="bottom_or_right" ID="ID_499870406" CREATED="1769251786707" MODIFIED="1769251786707"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251785907-7355">
      数组
    </div>
  </body>
</html>
</richcontent>
<node ID="ID_1400962543" CREATED="1769251789618" MODIFIED="1769251789618"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251788184-4426">
      就是相同数据类型的元素按照一定顺序排列的集合
    </div>
  </body>
</html>
</richcontent>
</node>
<node ID="ID_1213708029" CREATED="1769251797210" MODIFIED="1769251797210"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251790843-7341">
      索引键可以使用整数表示，数组的大小不是固定的
    </div>
  </body>
</html>
</richcontent>
</node>
<node ID="ID_1657210330" CREATED="1769251835687" MODIFIED="1769251835687"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251835078-5867">
      索引值默认以 1 为起始
    </div>
  </body>
</html>
...
<node POSITION="top_or_left" ID="ID_938265214" CREATED="1769251807937" MODIFIED="1769251807937"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251807470-4570">
      一维数组
    </div>
  </body>
</html>
</richcontent>
<node TEXT="举例" ID="ID_501705843" CREATED="1769251812080" MODIFIED="1769251815517">
<icon BUILTIN="idea"/>
<node TEXT="array = {&quot;Lua&quot;, &quot;Tutorial&quot;}&#xa;&#xa;for i= 0, 2 do&#xa;   print(array[i])&#xa;end" ID="ID_1131635744" CREATED="1769251819403" MODIFIED="1769251820577">
<node ID="ID_204236880" CREATED="1769251825116" MODIFIED="1769251825116"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251824641-5404">
      输出
    </div>
  </body>
</html>
</richcontent>
<node ID="ID_1048398771" CREATED="1769251827058" MODIFIED="1769251833419"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251826399-6780">
      nil Lua Tutorial
    </div>
  </body>
</html>
...
<node POSITION="top_or_left" ID="ID_695962879" CREATED="1769251809982" MODIFIED="1769251809982"><richcontent TYPE="NODE">
...
<html>
  ...
  <body>
    <div xmind-vk-rich-text-fragment-id="1769251809077-8074">
      多维数组
    </div>
  </body>
</html>
</richcontent>
<node TEXT="举例" ID="ID_1358961438" CREATED="1769251812080" MODIFIED="1769251815517">
<icon BUILTIN="idea"/>
<node TEXT="array = {}&#xa;for i=1,3 do&#xa;   array[i] = {}&#xa;      for j=1,3 do&#xa;         array[i][j] = i*j&#xa;      end&#xa;end" ID="ID_39325862" CREATED="1769251845449" MODIFIED="1769251848998"/>
</node>
</node>
</node>
</map>
